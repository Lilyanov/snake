package com.projects.smoko.manager;

import com.projects.smoko.snake.BoxSet;
import com.projects.smoko.snake.MovingFood;
import com.projects.smoko.snake.Snake;
...
public class GameBoardManager extends JPanel {
    ...
    public GameBoardManager() {
        // засича когато потребителят натисне копче
